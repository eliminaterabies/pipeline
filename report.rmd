...
* Download a version of the animal contact tracing dateset from Wise Monkey and rename it "Animal_CT.csv" in dropbox.

* Run pipeline to generate all the problematic cases that fail the checks.
* Fix the cases on Wise Monkey and repeat first two steps.
...
<p style="color:red">MLi: The first case with suspect Yes/Todo with suspect critaria records is ID 224, on 2003-08-19, but records after 2010-01-01 looks more plausible. I am using 2010-01-01 as a soft cutoff.</p>
