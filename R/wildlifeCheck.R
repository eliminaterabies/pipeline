...
library(dplyr)
library(shellpipes)
rpcall("Serengeti_Animal_wildlifeCheck.Rout R/wildlifeCheck.R Serengeti_Animal_dat.rds R/helpfuns.R")
rpcall("Serengeti_Dog_wildlifeCheck.Rout R/wildlifeCheck.R Serengeti_Dog_dat.rds R/helpfuns.R")
sourceFiles()
animals <- rdsRead()
